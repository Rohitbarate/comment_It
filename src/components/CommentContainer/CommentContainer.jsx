...
function CommentContainer() {
  ...
  return (
    <div className="commentContainer">
      <Link to="/">
        <ImCross className="icon cancelIcon" />
      </Link>
          ...
          <div className="headerChatBox">
            <div className="user">
              ...
              <span className="userName">
                {item.owner.firstName}_{item.owner.lastName}
              </span>
            </div>
                        ...
                        return (
                          <div className="CmntChatBox">
                            <div className="cmntUser">
                              <div className="row">
                                <img
                                  src={ele.owner.picture}
                                  alt="error"
                                  className="comntUserImg"
                                />
                                <span className="userName">
                                  {ele.owner.firstName}_{ele.owner.lastName}
                                </span>
                              </div>
                              <span className="moreButton">
                                {" "}
